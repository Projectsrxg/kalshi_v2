...
SELECT create_hypertable('trades', by_range('exchange_ts'),
...
SELECT create_hypertable('orderbook_deltas', by_range('exchange_ts'),
...
SELECT create_hypertable('orderbook_snapshots', by_range('snapshot_ts'),
    chunk_time_interval => 86400000000);  -- 1 day in microseconds
...
SELECT create_hypertable('tickers', by_range('exchange_ts'),
    chunk_time_interval => 3600000000);  -- 1 hour in microseconds
