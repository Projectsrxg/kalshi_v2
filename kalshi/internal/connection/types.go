...
func DefaultManagerConfig() ManagerConfig {
	return ManagerConfig{
		...
		WorkerCount:        10,
		SubscribeBatchSize: 1000, // Batch up to 1000 markets per subscribe command
	}
}
...
type Subscription struct {
	...
	Channel string
	ConnID  int
	Ticker  string   // Empty for global subscriptions (deprecated for batch)
	Tickers []string // Markets in this subscription (for batch subscriptions)
}
